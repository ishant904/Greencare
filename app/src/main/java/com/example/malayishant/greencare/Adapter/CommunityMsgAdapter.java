...
public class CommunityMsgAdapter extends ArrayAdapter<CommunityMessage> {
    public  CommunityMsgAdapter(Context context, int resource, List<CommunityMessage> objects) {
